...
export const metadata: Metadata = {
  title: 'Claim Your Fertility Specialist Listing',
...
export default function ClaimIndexPage() {
  return (
    <div className="mx-auto max-w-lg px-4 py-20">
      <h1 className="text-2xl font-bold text-gray-900 mb-3">Claim Your Fertility Specialist Listing</h1>
      ...
      <form action="/listings" method="GET" className="flex flex-col gap-3 sm:flex-row">
        <input
          type="text"
          name="q"
          placeholder="Your your name or clinic name..."
          required
